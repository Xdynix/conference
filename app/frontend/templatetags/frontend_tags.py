        ...
        json.dumps(
            {
                ...
                "PaymentCurrency": _enum_to_dict(PaymentCurrency),
                "PaymentMethod": _enum_to_dict(PaymentMethod),
                "PaymentType": _enum_to_dict(PaymentType),
                "RegistrationState": _enum_to_dict(RegistrationState),
                "RegistrationTitle": _enum_to_dict(RegistrationTitle),
