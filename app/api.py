...
from app.conference.api.doc import router as doc_router
from app.conference.api.duplicate import router as duplicate_router
...
from app.conference.api.proof import router as proof_router
